  ...
  useEffect(() => {
    if (post) {
      ...
      if (post.coverImageUrl) {
        setCurrentImageKey(post.coverImageUrl);
      }
    }
  }, [post, form]);
  ...
  const updatePostMutation = useMutation({
    mutationFn: async (data: PostFormData) => {
      const postData = {
        ...
        coverImageUrl: currentImageKey || undefined,
    ...
    onSuccess: () => {
      // Invalidar cache dos posts para atualizar a listagem
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-3 flex items-center justify-center">
            <i className="fas fa-edit mr-4 text-primary"></i>
            Editar Post
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Atualize o conteúdo do seu post. Use Markdown para formatação rica.
          </p>
        </div>
            ...
            <div className="xl:col-span-2 space-y-6">
              ...
              <Card className="border-2 border-green-200 dark:border-green-800">
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    Edite o conteúdo principal do post usando Markdown
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="border-2 border-blue-200 dark:border-blue-800">
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    Edite ou adicione uma versão em inglês (opcional)
                  </CardDescription>
                </CardHeader>
